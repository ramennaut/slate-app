...
export default function NotesSidebar({
  ...
  return (
    <div className={`flex flex-col h-full bg-sidebar/50 backdrop-blur-sm border-r border-sidebar-border/60 overflow-hidden transition-all duration-300 ease-in-out ${isCollapsed ? 'w-16' : 'w-full'}`}>
      {/* Sidebar Header */}
              ...
              {notes.map((note) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`min-w-0 ${isActive ? 'pl-2' : ''} ${isCollapsed ? 'hidden' : ''}`}>
